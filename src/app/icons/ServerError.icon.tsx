...
const ServerErrorIcon = (props: SvgProps) => (
  <Svg width={1119.609} height={699} viewBox='0 0 1119.609 699' data-name='Layer 1' {...props}>
    <Circle cx={292.609} cy={213} r={213} fill='#f2f2f2' />
    <Path fill='#2f2e41' d='M0 51.142c0 77.498 48.618 140.209 108.7 140.209' />
    <Path fill='#f50057' d='M108.7 191.35c0-78.368 54.256-141.783 121.304-141.783' />
    <Path fill='#f50057' d='M39.384 58.168c0 73.614 31.003 133.183 69.317 133.183' />
    ...
    />
    <Path fill='#f50057' d='M271.609 150h16v16h-16z' opacity={0.4} />
    <Path fill='#f50057' d='M294.609 150h16v16h-16z' opacity={0.8} />
    <Path fill='#f50057' d='M317.609 150h16v16h-16z' />
    <Path fill='#f50057' d='M271.609 251h16v16h-16z' opacity={0.4} />
    <Path fill='#f50057' d='M294.609 251h16v16h-16z' opacity={0.8} />
    <Path fill='#f50057' d='M317.609 251h16v16h-16z' />
    <Path fill='#f50057' d='M271.609 352h16v16h-16z' opacity={0.4} />
    <Path fill='#f50057' d='M294.609 352h16v16h-16z' opacity={0.8} />
    <Path fill='#f50057' d='M317.609 352h16v16h-16z' />
